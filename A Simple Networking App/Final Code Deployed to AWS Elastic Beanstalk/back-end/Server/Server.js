...
app.use(
  cors({
    origin: "https://staging.d3mzl9txdon4md.amplifyapp.com",
  })
);
...
app.get("/profile", cors(), authenticateToken, (req, res) => {
  res.json({ message: "Profile data" });
});

app.post("/profile", cors(), authenticateToken, async (req, res) => {
  const {
    name,
    username,
    age,
...
app.get("/profile/:userId", cors(), authenticateToken, async (req, res) => {
...
app.get("/profile/name/:name", cors(), async (req, res) => {
...
app.get("/profiles", cors(), authenticateToken, async (req, res) => {
  try {
...
app.post("/connect", cors(), authenticateToken, async (req, res) => {
...
app.get("/network", cors(), authenticateToken, async (req, res) => {
  const userId = req.user.userId;
...
app.post("/logout", cors(), authenticateToken, (req, res) => {
